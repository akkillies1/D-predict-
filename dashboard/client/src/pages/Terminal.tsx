...
export default function Terminal() {
  ...
  const atm = market?.close != null && strikes.length ? strikes.reduce((best, strike) => Math.abs(strike - market.close!) < Math.abs(best - market.close!) ? strike : best, strikes[0]) : null;
